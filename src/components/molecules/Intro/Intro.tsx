...
export default function Intro() {
  return (
    <section className="z-[998] relative mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      <motion.h1
        className="mb-10 mt-10 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl tracking-wider"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <span className="font-bold text-6xl ">Hi, I`m M. Dhiya Ulhaq.</span> as{" "}
