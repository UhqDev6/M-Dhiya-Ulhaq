  ...
  return (
    <Html lang="en" className="!scroll-smooth">
      ...
      <body>
        ...
        <div className="bg-[#dbd7fb] absolute top-[-1rem] left-[-35rem] h-[32.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
        <Main />
        <NextScript />
      </body>
    </Html>
